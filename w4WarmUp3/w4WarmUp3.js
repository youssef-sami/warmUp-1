...
//creates a list item and add it to the unordered list, then add a class to the
// added item alternatively (So first time Class1 then next time Class2 then Class1 and repeat)
