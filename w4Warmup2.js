...
// 5. The function should change the color of the headline to green if the result is smaller than 100, to blue if it’s equal to or larger than 100 and to red if the input in the first or the third text fields is not a number and if the second text field is not one of the 4 operations (wrong inputs)
